      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="font-sans text-[0.8rem] text-white/40 leading-relaxed max-w-xs">
              Independent tax, accounting, and advisory for Chicago&apos;s small
              businesses. Real partnership. Year-round support.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1.5 font-sans text-[0.78rem] text-white/40">
              ...
              <a
                href="mailto:hello@halstedledger.com"
                className="block text-gold/70 hover:text-gold transition-colors"
              >
        ...
        <div className="pt-8 border-t border-white/[0.07] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <p className="font-sans text-[0.68rem] text-white/20">
            © 2025 Halsted Ledger &ensp;·&ensp; Chicago, IL &ensp;·&ensp; Not a
            real firm. Concept build for JBAR Design Studio.
          </p>
